...
const EditBlogPost = () => {
    ...
    return (
        <div className="bg-white p-4 mx-5 grid grid-cols-2 gap-4">
            <div className='m-4 p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700'>
                <h2 className='text-lg font-semibold'>Blog Post Form</h2>
                <BlogPostForm />
